...
async function ensureIsViewedAttribute() {
    ...
    try {
        await databases.createBooleanAttribute(parserEnv.APPWRITE_DATABASE_ID, parserEnv.APPWRITE_TENDERS_COLLECTION_ID, 'isViewed', false, false);

...
const normalizedEnv = {
    ...
    APPWRITE_TENDERS_COLLECTION_ID: process.env.APPWRITE_TENDERS_COLLECTION_ID ??
        process.env.VITE_APPWRITE_TENDERS_COLLECTION_ID ??
        process.env.VITE_APPWRITE_COLLECTION_ID,
    APPWRITE_PARSER_STATE_COLLECTION_ID: process.env.APPWRITE_PARSER_STATE_COLLECTION_ID ??
